            ...
            <div class="modal-body p-4">
                <form id="createEmpresaForm" method="POST" action="{{ route('empresas.store') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control text-uppercase @error('nombre_empresa') is-invalid @enderror" name="nombre_empresa" value="{{ old('nombre_empresa') }}" autocomplete="off" required oninput="this.value = this.value.toUpperCase()">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form id="UpdateEmpresaForm" method="POST" action="">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw-bold small text-muted">Nombre de la Empresa</label>
                        <input type="text" class="form-control text-uppercase" name="nombre_empresa" id="edit-nombre-empresa" autocomplete="off" required oninput="this.value = this.value.toUpperCase()">
