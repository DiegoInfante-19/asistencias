<header
    ...
    <!-- Se ajustó la alineación para mantener todo en su sitio sin el buscador -->
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        
        <!-- Lado Izquierdo: Botón Hamburguesa -->
        <div
            class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-start xl:w-auto xl:border-b-0 xl:px-0 lg:py-4">
            ...
            <!-- Logo (mobile only) -->
            <a href="{{ route('admin.index') }}" class="xl:hidden flex items-center gap-2">
        ...
        <!-- Lado Derecho: Acciones (Theme y Usuario) -->
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            class="items-center justify-end w-full gap-4 px-5 py-4 xl:flex shadow-theme-md xl:px-0 xl:shadow-none">
            ...
            <!-- User Dropdown (Perfil de Usuario) -->
