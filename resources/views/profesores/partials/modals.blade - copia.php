                ...
                <form id="editUserForm" method="POST" action="">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" value="{{ old('_method') == 'PUT' ? old('username') : '' }}" autocomplete="off" required pattern="{{ config('regex.username.html') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('_method') == 'PUT' ? old('email') : '' }}" autocomplete="off" required pattern="{{ config('regex.email.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Nombres</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('_method') == 'PUT' ? old('name') : '' }}" autocomplete="off" required pattern="{{ config('regex.name.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Apellidos</label>
                            <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" value="{{ old('_method') == 'PUT' ? old('last_name') : '' }}" autocomplete="off" required pattern="{{ config('regex.last_name.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted text-uppercase">Cédula</label>
                            <input type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" id="cedula" value="{{ old('_method') == 'PUT' ? old('cedula') : '' }}" autocomplete="off" required pattern="{{ config('regex.cedula.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted text-uppercase">Teléfono</label>
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="edit-phone" value="{{ old('_method') == 'PUT' ? old('phone') : '' }}" autocomplete="off" pattern="{{ config('regex.phone.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="modal-body p-4">
                <form id="createUserForm" method="POST" action="{{ route('usuarios.store') }}">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Nombre de Usuario</label>
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" value="{{ old('origen') == 'modal' ? old('username') : '' }}" autocomplete="off" required >
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Correo Electrónico</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('origen') == 'modal' ? old('email') : '' }}" autocomplete="off" required pattern="{{ config('regex.email.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Nombres</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('origen') == 'modal' ? old('name') : '' }}" autocomplete="off" required pattern="{{ config('regex.name.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted text-uppercase">Apellidos</label>
                            <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" value="{{ old('origen') == 'modal' ? old('last_name') : '' }}" autocomplete="off" required pattern="{{ config('regex.last_name.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted text-uppercase">Cédula</label>
                            <input type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" id="cedula" value="{{ old('origen') == 'modal' ? old('cedula') : '' }}" autocomplete="off" required pattern="{{ config('regex.cedula.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted text-uppercase">Teléfono</label>
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('origen') == 'modal' ? old('phone') : '' }}" autocomplete="off" pattern="{{ config('regex.phone.html') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" required pattern="{{ config('regex.password.html') }}">
                            <div class="invalid-feedback dynamic-feedback fw-bold"></div>
                        </div>
                        <div class="col-md-6">
