...
Route::middleware(['auth', 'no-back-history'])->group(function () { 
    ...
    Route::middleware(['role:Administrador,Coordinador'])->group(function () {
        ...
        Route::post('/usuarios/{usuario}/asignar-grupo', [UserController::class, 'asignarGrupo'])->name('usuarios.asignar_grupo');
        Route::delete('/usuarios/{id_usuario}/remover-grupo/{id_grupo}', [UserController::class, 'removerGrupo'])->name('usuarios.remover_grupo');
